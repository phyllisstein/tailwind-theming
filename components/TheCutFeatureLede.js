        ...
        <div className="max-w-6xl m-auto my-24">
            <div className="w-full border pl-20 border-gray-400 mb-2">
                <div className="flex flex-row">
                    ...
                    <div className="uppercase tracking-widest text-xs mb-5 border-t border-black pt-4"><span className="font-chap-bold">In Conversation</span> <span className="text-red-500 px-2">|</span>  <span className="font-chap">May 27, 2021</span></div>
                    <div className="block mb-4">
                    <h1 className="font-canela text-6xl mb-1 inline mr-2">
