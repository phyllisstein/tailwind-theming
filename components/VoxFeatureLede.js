        ...
        <div className="w-full my-24 bg-vox-yellow pb-12">
            ...
            <div className="w-full pl-20">
                <div className="flex flex-row">
                    ...
                    <div className="text-xs mb-5"><span className="font-balto-bold pr-2 relative z-0 vox-highlight">Rideables</span> / <span className="font-balto pl-2 text-gray-500">May 27, 2021</span></div>
                    ...
                    <p className="font-balto text-chap-2xs pb-4 mb-8">By <span className="relative z-0 vox-highlight font-balto-bold">Andrew J. Hawkins</span> @andyjayhawk</p>
                    </div>
