...
export default function VoxFeatureLede() {
    return (
        <div className="w-full my-24 bg-vox-yellow pb-8">
            <div className="max-w-6xl m-auto">
            <div className="w-full pl-20">
                <div className="flex flex-row">
                    <div className="max-w-lg flex flex-col justify-center absolute top-1/3 left-1/4">
        ...
        <figcaption className="font-balto text-gray-500 text-chap-2xs w-1/2 ml-auto pl-20 tracking-normal">Image: Bird
        </figcaption>
    </div>
    )
}