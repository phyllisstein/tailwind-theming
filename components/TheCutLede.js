...
export default function TheCutLede() {
    return (
        <div className="max-w-6xl m-auto my-24 pt-4 border-t border-black">
            <div className="uppercase text-chap-2xs mb-5"><span className="font-chap-bold">Rideables</span> <span className="text-red-500 px-2">|</span>  <span className="font-chap">May 27, 2021</span></div>
            <h1 className="font-canela text-canela-2xl mb-2">
                Bird announces its third-generation electric scooter with automatic emergency braking
            </h1>
            <p className="font-chap text-chap-2xs border-b border-gray-300 pb-4 mb-8">By Andrew J. Hawkins</p>
            <figure>
                ...
                <figcaption className="font-chap text-gray-500 text-chap-2xs tracking-normal">Photo: Bird</figcaption>
            </figure>
      </div>
    )
  }