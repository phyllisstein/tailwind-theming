...
export default function TheCutLede() {
    return (
        <div className="max-w-6xl m-auto my-24 pt-4 border-t border-black">
            ...
            <p className="font-chap text-sm border-b border-gray-300 pb-4 mb-8">By Andrew J. Hawkins</p>
            <figure>
                ...
                <figcaption className="font-chap text-gray-500 text-xs">Photo: Bird</figcaption>
            </figure>
      </div>
    )
  }